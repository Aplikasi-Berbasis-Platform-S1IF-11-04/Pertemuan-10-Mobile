...
#ifndef FLUTTER1_SWIFT_H
#define FLUTTER1_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8flutter111AppDelegate")
...
SWIFT_CLASS("_TtC8flutter117MainFlutterWindow")
