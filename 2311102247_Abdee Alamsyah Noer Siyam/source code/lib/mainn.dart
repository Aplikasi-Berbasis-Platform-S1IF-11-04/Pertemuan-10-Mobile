  ...
  class PenghitungMahsiswa extends StatefulWidget {
    ...
    @override
    State<PenghitungMahsiswa> createState() => _PenghitungMahsiswaState();
  }

  class _PenghitungMahsiswaState extends State<PenghitungMahsiswa> {
    int jumlahHadir = 0;
    ...
    Widget build(BuildContext context) {
      return Center(
        child: Column(
          ...
          children: [
            Text('Jumlah Praktikum ABP yang Hadir :', 
